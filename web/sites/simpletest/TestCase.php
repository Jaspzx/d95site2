        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/Users/jaspzx/Sites/d95site2/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl'
                );
            } else {
                $template = new Template(
                    '/Users/jaspzx/Sites/d95site2/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl'
                );
            }
